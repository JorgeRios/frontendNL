...
import { getCompraId } from "_api/compra";
  ...
  useEffect(() => {
    const fillData = async () => {
      ...
      try {
        ...
        const compra = await getCompraId(order.CompraId);
        console.log("viendo compra ", compra);
        formik.setFieldValue("folioFactura", compra.data.FolioFactura);
        setFolioFactura(compra.data.FolioFactura);
